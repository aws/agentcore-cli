...
The shared workflow reads PR discussion and publishes the Harness result with
the workflow run's short-lived **`GITHUB_TOKEN`**. The token is never sent to
the Harness runtime or persisted in this image.
