...
export type SessionSourceFlags = {
  [F in (typeof sessionSourceFlags)[number] as F["name"]]: F extends Flag<string, infer T>
    ? T
    : never;
};
...
export async function resolveSessionSource(
  ...
  return resolveDataSource(flags, rawDataSourceConfig);
}
...
function resolveWindow(flags: SessionSourceFlags): SessionWindow | undefined {
