  ...
  return withCommandRunTelemetry(
    ...
    async (recorder: AttributeRecorder<CommandAttrs<'export.harness'>>) => {
      ...
      writeExportNotes(
        ...
        harnessName,
        targetAgentName,
        join(context.projectRoot, 'app', targetAgentName)
      );
      ...
      return {
        ...
        agentPath: join(context.projectRoot, 'app', targetAgentName),
        notesPath: join(context.projectRoot, 'app', targetAgentName, EXPORT_NOTES_FILENAME),
      };
    }
  );
}
