...
The rendering logic is rooted in the `AgentEnvSpec` and must ALWAYS respect the configuration in the Spec. Tags defined in `agentcore.json` flow through to deployed CloudFormation resources.
