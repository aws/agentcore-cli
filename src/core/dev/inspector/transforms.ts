/**
 * Presentation transforms for the Agent Inspector: turn raw persisted OTLP data
 * into the flattened, noise-filtered shapes the frontend renders. Ingest-side
 * OTLP handling (partitioning, id normalization) lives in ../otel/transforms.
 */
import { hexFromB64OrString, nanoToMs } from "../otel/transforms";
import type {
  OtlpAttributes,
  OtlpAttributeValue,
  OtlpResource,
